...
import edu.kh.project.board.model.service.BoardSevice;
 ...
 * - afterCompletion (뷰완성후) : ViewResolver -> DispatcherServlet 사이 수행
 * 
 * */ 
@Slf4j
public class BoardTypeInterceptor implements HandlerInterceptor {
	...
	@Autowired // 의존성주입(DI) 
				//-> BoardService 타입이거나 상속관계인 객체(Bean) 주입
