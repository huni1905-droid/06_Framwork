...
VALUES(SEQ_MEMBER_NO.NEXTVAL,
			 'admin1@kh.or.kr','$2a$10$SC0KYLzAdtkZT12h5wTWT.csuiG.boiRC4ct6Mioe5puIo4W7GZmW', -- pass01!
			 '관리자1',
			 '01012341234',
...
WHERE B.BOARD_NO = L.BOARD_NO) lIKE_COUNT
FROM "BOARD" B
JOIN "MEMBER" USING(MEMBER_NO)
JOIN "BOARD_TYPE" USING(BOARD_CODE)
...
SENDER_NO, CHATTING_ROOM_NO NG_ROOM_NO,
